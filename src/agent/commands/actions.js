...
export const actionsList = [
    {
        ...
        perform: async function (agent, prompt) {
            ...
            const actionFn = async () => {
                try {
                    // Use CodeEngine (Unified Intelligence) instead of legacy Coder
                    result = await agent.intelligence.generateCode(agent.history);
                } catch (e) {
    ...
    },
    {
        ...
        perform: async function (agent, name) {
            ...
            agent.memory.setPlace(name, { x: pos.x, y: pos.y, z: pos.z });
    ...
    },
    {
        ...
        perform: runAsAction(async (agent, name) => {
            const pos = agent.memory.getPlace(name);
            if (!pos) {
